...
#11 is the Ace. 
def deal_card():
    """Retuen a random card from the deck."""
    cards = [11, 2, 3, 4, 5, 6, 7, 8, 9, 10, 10, 10, 10]
...
def play_game():
    ...
    while not is_game_over:
        ...
        if user_score == 0 or computer_score == 0 or user_score >21:
            ...
            user_should_deal = input("Type 'y' to get anopther card, type 'n' to pass: ")
...
while input("Do you wanna play game of Blackjack? Type 'y' or 'n' : ") == "y":
    os.system("cls")
    play_game()